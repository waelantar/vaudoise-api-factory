...
import com.vaudoise.api_factory.infrastructure.web.validation.ValidCompanyIdentifier;
...
public record CreateCompanyRequest(
    ...
    @NotBlank(message = "Company identifier is required") @ValidCompanyIdentifier
